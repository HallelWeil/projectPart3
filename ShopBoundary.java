...
public class ShopBoundary {
	...
	public ShopBoundary(CartController cartCon, CatalogController catalogCon) {
		this.cartCon = cartCon;
		this.catalogCon = catalogCon;
	}
	//category methods//
/**
 ...
 * @throws an exception -when the user tries to add a new product that has a name that already exist in the cart
 */
 ...
 * @param isHomedelivery, true- when home delivery is chosen ,false - when a store pickup is chosen 
 */
 ...
 *  @return true - when the payment is approved , false- when payment wasn't completed successfully
 */
